    ...
    <div class="ml-64 mt-[120px] p-8">
        <div class="w-full max-w-3xl bg-white p-8 rounded-lg shadow-lg">
            ...
            <form>
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 font-semibold mb-2" for="eventImage">Upload Event Image</label>
                    <input type="file" id="eventImage" class="w-full border rounded px-4 py-2 bg-gray-100">
                </div>

                <!-- QR Code Download Section tidak ada karena ini form upload
                <div class="mb-6">
                ...
                <!-- Note Section tidak ada karena ini form upload
                <div class="mb-6">
