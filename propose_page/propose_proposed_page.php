...
<script>
    ...
    // Konsumsi API
    const apiUrl = 'http://localhost/pbl/api-03/routes/events.php';
            ...
            if (data.status === 'success') {
                ...
                newProposedEvents.forEach((event, index) => {
                    table.row.add([
                        ...
                        event.status,
                        `<a href="propose_noted_event.php?event_id=${event.event_id}" class="text-blue-500 hover:text-blue-800">View details</a>`
                    ]);
                });
